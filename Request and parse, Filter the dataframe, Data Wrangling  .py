...
data_falcon9=data[data['BoosterVersion'].str.contains('Falcon 9')]
data_falcon9[["FlightNumber","BoosterVersion"]]
...
avg_PayloadMass = data["PayloadMass"].astype("float").mean(axis=0)
print(avg_PayloadMass)
